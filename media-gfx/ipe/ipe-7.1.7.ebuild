...
inherit eutils qt4-r2 toolchain-funcs versionator

PV1=$(get_major_version ${PV})
PV2=$(get_version_component_range 1-2 ${PV})

DESCRIPTION="Drawing editor for creating figures in PDF or PS formats"
HOMEPAGE="http://ipe7.sourceforge.net/"
SRC_URI="mirror://sourceforge/project/${PN}${PV1}/${PN}/${PV2}/${P}-src.tar.gz"
...
src_prepare() {
	...
	# epatch "${FILESDIR}"/ipe-7.1.3-gold.patch
}
